...
class FillPermissionsForPengajar extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPengajar constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.pengajar',
            'admin.pengajar.index',
            'admin.pengajar.create',
            'admin.pengajar.show',
            'admin.pengajar.edit',
            'admin.pengajar.delete',
            'admin.pengajar.bulk-delete',
        ]);
