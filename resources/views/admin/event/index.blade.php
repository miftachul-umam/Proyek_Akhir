...
<a href ="fullcalender"><button>Tambah Event</button></a>
    <event-listing
        :data="{{ $data->toJson() }}"
                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'start'">{{ trans('admin.event.columns.start') }}</th>
                                        <th is='sortable' :column="'end'">{{ trans('admin.event.columns.end') }}</th>
